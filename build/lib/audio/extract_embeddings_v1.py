...
def main():
    ...
    if valid_results:
        ...
        np.savez_compressed(os.path.join(processed_dir, "perch_v1_embeddings.npz"), embeddings=embeddings, indices=valid_idx)
        train_df.iloc[valid_idx].to_csv(os.path.join(processed_dir, "train_with_perch_v1.csv"), index=False)
